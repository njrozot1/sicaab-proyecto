<%-- 
    Document   : Orden-Compra-buscar
    Created on : 01-jul-2020, 22:20:57
    Author     : Nisanech
--%>
    ...
    <body>
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CLIENTES
                </h3>
            </div>
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a href="../Clientes/cliente-nuevo.html"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR CLIENTE</a>
                    </li>
                    <li>
                        <a  href="../Clientes/cliente-lista.html"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CLIENTES</a>
                    </li>
                    <li>
                        <a class="active" href="../Clientes/cliente-buscar.html"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CLIENTE</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="buscar" class="bmd-label-floating">¿Qué cliente estás buscando?</label>
