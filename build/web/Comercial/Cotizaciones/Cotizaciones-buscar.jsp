<%-- 
    Document   : Cotizaciones-buscar
    Created on : 01-jul-2020, 22:18:58
    Author     : Nisanech
--%>
        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a href="../Cotizaciones/Cotizaciones-nuevo.jsp"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR COTIZACIÓN</a>
                    </li>
                    <li>
                        <a  href="../Cotizaciones/Cotizaciones-lista.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE COTIZACIONES</a>
                    </li>
                    <li>
                        <a class="active" href="../Cotizaciones/Cotizaciones-buscar.jsp"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR COTIZACIONES</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="buscar" class="bmd-label-floating">¿Qué cotización estás buscando?</label>
