<%-- 
    Document   : Cotizaciones-lista
    Created on : 01-jul-2020, 22:19:17
    Author     : Nisanech
--%>
    ...
    <body>
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE COTIZACIONES
                </h3>
            </div>
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="../Cotizaciones/Cotizaciones-lista.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE COTIZACIONES</a>
                    </li>
                    <li>
