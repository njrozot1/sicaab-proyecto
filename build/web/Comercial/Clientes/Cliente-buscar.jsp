<%-- 
    Document   : Cliente-buscar
    Created on : 01-jul-2020, 22:17:45
    Author     : Nisanech
--%>
            ...
            <section class="full-box page-content">
                ...
                <div class="container-fluid">
                    <ul class="full-box list-unstyled page-nav-tabs">
                        <li>
                            <a href="../Clientes/Cliente-nuevo.jsp"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR CLIENTE</a>
                        </li>
                        <li>
                            <a  href="../Clientes/Cliente-lista.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CLIENTES</a>
                        </li>
                        <li>
                            <a class="active" href="../Clientes/Cliente-buscar.jsp"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CLIENTE</a>
                        </li>
                    </ul>
                </div>
