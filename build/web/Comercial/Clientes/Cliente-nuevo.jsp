<%-- 
    Document   : Cliente-nuevo
    Created on : 01-jul-2020, 22:18:22
    Author     : Nisanech
--%>
        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a class="active" href="../Clientes/Cliente-nuevo.jsp"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR CLIENTE</a>
                    </li>
                    <li>
                        <a href="../Clientes/Cliente-lista.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CLIENTES</a>
                    </li>
                    <li>
                        <a  href="../Clientes/Cliente-buscar.jsp"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CLIENTE</a>
                    </li>
                </ul>
            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="cliente_NIT" class="bmd-label-floating">NIT</label>
                                        <input type="text" pattern="[a-zA-Z0-9-]{1,27}" class="form-control" id="cliente_NIT" id="cliente_NIT" maxlength="27">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="cliente_razon_social" class="bmd-label-floating">Razón Social</label>
                                        <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ]{1,45}" class="form-control" name="cliente_razon_social" id="cliente_razon_social" maxlength="45">
                                    </div>
                                </div>
