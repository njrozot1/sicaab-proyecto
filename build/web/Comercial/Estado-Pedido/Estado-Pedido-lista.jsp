<%-- 
    Document   : Estado-Pedido-lista
    Created on : 01-jul-2020, 22:20:18
    Author     : Nisanech
--%>
        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a class="active" href="../Estado-Pedido/Estado-Pedido-lista.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PEDIDOS</a>
                    </li>
                    <li>
                        <a href="../Estado-Pedido/Estado-Pedido-buscar.jsp"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR PEDIDO</a>
                    </li>
                </ul>
            </div>
