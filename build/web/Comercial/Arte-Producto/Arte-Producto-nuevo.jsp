<%-- 
    Document   : Arte-Producto-nuevo
    Created on : 01-jul-2020, 22:17:10
    Author     : Nisanech
--%>

<%@page import="Modelo.Cliente"%>
<%@page import="ModeloDB.ClienteDB"%>
<%@page import="ModeloDB.CategoriaDB"%>
                    ...
                    <nav class="full-box nav-lateral-menu">
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="Arte-Producto-lista.jsp"><i class="fas fa-paint-roller fa-fw"></i> &nbsp; Arte Producto</a>
                                    </li>
                                    <li>
        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a class="active" href="Arte-Producto-nuevo.jsp"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ARTE</a>
                    </li>
                    <li>
                        <a href="Arte-Producto-lista.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE ARTES</a>
                    </li>
                    <li>
                        <a href="Arte-Producto-buscar.jsp"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ARTE</a>
                    </li>
                </ul>
            </div>
            ...
            <!-- Contenido -->
            <div class="container-fluid">
                <form action="ControladorProducto" method="POST" class="form-neon" autocomplete="off">
                    <fieldset>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="arte_nombre" class="bmd-label-floating">Nombre del Producto</label>
                                        <input type="text" name="txtnom"  class="form-control" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="arte_dimensiones" class="bmd-label-floating">Dimensiones</label>
                                        <input type="text" name="txtdime"  class="form-control" maxlength="45">
                                    </div>
                                </div>
                                
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="arte_categoria" class="vmd-label-floating">Categoría</label>
                                        <select class="form-control" name="txtidcate">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="arte_cliente" class="vmd-label-floating">Cliente</label>
                                        <select class="form-control" name="txtidclien" id="arte_cliente">
                                            <option value="" selected="" disabled="">Seleccione un cliente</option>
                                            <%
                                                ArrayList<Cliente> lista2 = ClienteDB.Obtenercliente();
                                                for(Cliente clien : lista2){
                                            %>
                                            <option value="<%=clien.getID_CLIENTE()%>"><%=clien.getRAZON_SOCIAL()%></option>
                                            <%
                                                }
                                            %>
                                        </select>
                    ...
                    <p class="text-center" >
                        ...
                        &nbsp; &nbsp;
                        <input type="submit" name="accion" value="Guardar" class="btn btn-raised btn-info btn-sm">
                    </p>
                </form>
            </div>
        </section>
