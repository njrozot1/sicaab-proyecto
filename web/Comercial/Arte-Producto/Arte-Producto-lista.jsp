<%-- 
    Document   : Arte-Producto-lista
    Created on : 01-jul-2020, 22:16:55
    Author     : Nisanech
--%>
            ...
            <section class="full-box page-content">
                ...
                <div class="container-fluid">
                    <ul class="full-box list-unstyled page-nav-tabs">
                        ...
                        <li>
                            <a class="active" href="Arte-Producto-lista.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE ARTES</a>
                        </li>
                        <li>
