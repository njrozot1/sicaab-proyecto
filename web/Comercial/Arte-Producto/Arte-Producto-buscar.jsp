<%-- 
    Document   : Arte-Producto-buscar
    Created on : 01-jul-2020, 22:16:42
    Author     : Nisanech
--%>
...
<%@page import="ModeloDB.CategoriaDB"%>
<%@page import="ModeloDB.CategoriaDB"%>
<%@page import="ModeloDB.ArteProductosDB"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.ArrayList"%>
<%@page import="Modelo.ArteProductos"%>
<%@page import="Modelo.ArteProductos"%>
<%@page import="Modelo.ArteProductos"%>
<%@page import="Modelo.ArteProductos"%>
<%@page import="Modelo.ArteProductos"%>
    ...
    <body>
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ARTE
                </h3>
            </div>
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a href="Arte-Producto-nuevo.jsp"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ARTE</a>
                    </li>
                    <li>
                        <a href="Arte-Producto-lista.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE ARTES</a>
                    </li>
                    <li>
                        <a class="active" href="Arte-Producto-buscar.jsp"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ARTE</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="buscar" class="bmd-label-floating">¿Qué arte estás buscando?</label>
                                    <input type="text" class="form-control" name="buscar" id="buscar" maxlength="45">
                                </div>
                            </div>
                            <div class="col-12">
                                <p class="text-center">
            ...
            <div class="container-fluid">
                <div class="table-responsive">
                    <table class="table table-dark table-sm">
                        ...
                        <%
                            ArrayList<ArteProductos> lista = ArteProductosDB.ObtenerProducto();
                            for(ArteProductos pro : lista){
                        %>
                        <tbody>
                            <tr class="text-center">
                                <td><%=pro.getID_ARTE_PRODUCTO()%></td>
                                <td><%=pro.getNOMBRE_PRODUCTO()%></td>
                                <td><%=pro.getDIMENSIONES()%></td>
                                <td><%=CategoriaDB.getnombre(pro.getID_CATEGORIA())%></td>
                                <td><%=ClienteDB.getnombre(pro.getID_CLIENTE())%></td>
                                <td>
