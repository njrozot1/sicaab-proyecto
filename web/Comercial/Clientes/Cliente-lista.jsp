<%-- 
    Document   : Cliente-lista
    Created on : 01-jul-2020, 22:18:03
    Author     : Nisanech
--%>
        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="../Clientes/Cliente-lista.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CLIENTES</a>
                    </li>
                    <li>
