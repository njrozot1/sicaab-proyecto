<%-- 
    Document   : Estado-Pedido-buscar
    Created on : 01-jul-2020, 22:20:04
    Author     : Nisanech
--%>
...
<section class="full-box page-content">
    ...
    <div class="container-fluid">
        <ul class="full-box list-unstyled page-nav-tabs">
            <li>
                <a  href="../Estado-Pedido/Estado-Pedido-lista.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PEDIDOS</a>
            </li>
            <li>
                <a class="active" href="../Estado-Pedido/Estado-Pedido-buscar.jsp"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR PEDIDOS</a>
            </li>
        </ul>
    </div>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="buscar" class="bmd-label-floating">¿Qué pedido estás buscando?</label>
